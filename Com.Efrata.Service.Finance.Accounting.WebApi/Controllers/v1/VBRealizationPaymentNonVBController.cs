...
namespace Com.Efrata.Service.Finance.Accounting.WebApi.Controllers.v1
{
    ...
    [ApiVersion("1.0")]
    [Route("v{version:apiVersion}/vb-realization-payment-non-vb")]
    [Authorize]
    public class VBRealizationPaymentNonVBController : ControllerBase
    {
        private readonly IIdentityService _identityService;
        private readonly IVBRealizationPaymentNonVBService _service;
        private readonly IValidateService _validateService;
        private const string ApiVersion = "1.0";

        public VBRealizationPaymentNonVBController(IServiceProvider serviceProvider)
        {
            _identityService = serviceProvider.GetService<IIdentityService>();
            _service = serviceProvider.GetService<IVBRealizationPaymentNonVBService>();
        ...
        [HttpPost]
        public async Task<IActionResult> PostNonPO([FromBody] VBRealizationPaymentNonVBViewModel form)
        {
            try
            {
                VerifyUser();
        ...
        [HttpPut("{id}")]
        public virtual async Task<IActionResult> PutNonPO([FromRoute] int id, [FromBody] VBRealizationPaymentNonVBViewModel form)
        {
            try
            {
                VerifyUser();
        ...
        public async Task<IActionResult> GetPDFNonPO([FromRoute] int id)
        {
            try
            {
                ...
                else
                {
                    ...
                    VBRealizationPaymentNonVBPDFTemplate PdfTemplate = new VBRealizationPaymentNonVBPDFTemplate();
